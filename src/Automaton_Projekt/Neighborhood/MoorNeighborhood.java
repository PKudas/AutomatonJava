...
/**
 * Represents Moor neighborhood strategy
 * @author Patryk
 * @since 05/01/2016
 * @version 1.0
 */
public class MoorNeighborhood implements CellNeighborhood {
     ...
     */
    public MoorNeighborhood(int hei,int wid,boolean wrap) {
        height = hei;
        width = wid;
        wrapup = wrap;
    }
    ...
    public Set<CellCoordinates> cellNeighbors(CellCoordinates coords) {
        ...
        if (wrapup) {            
            ...
            neighborsCoordinates.add(new Coords2D(leftneighbor,topneighbor));
            neighborsCoordinates.add(new Coords2D(leftneighbor,bottomneighbor));
            ...
            neighborsCoordinates.add(new Coords2D(rightneighbor,topneighbor));
            neighborsCoordinates.add(new Coords2D(rightneighbor,bottomneighbor));
        }
        else {
            leftneighbor = (coords.getX()-1) % width;
            rightneighbor = (coords.getX()+1) % width;
